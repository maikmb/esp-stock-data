...
/*
 * JD9165 MIPI-DSI panel driver, vendored for the Guition JC1060P470 (ESP32-P4,
 * 7" 1024x600 IPS) display used in this project. Ported unmodified from the
 * board vendor's reference firmware, which itself follows Espressif's
 * standard esp_lcd panel-vendor driver template.
 */
